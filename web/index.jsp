...
<html lang="es">
  ...
  <body>
    ...
    <!-- Boton para lanzar ventana modal -->
    <button type="button" class="btn btn-info btn-lg" data-bs-toggle="modal" data-bs-target="#modalEmpleado" onclick="limpiar()">Nuevo</button>
          ...
          <div class="modal-content">
            <div class="modal-body">
              <form action="sr_empleado" method="POST" class="form-group">
                ...
                <button name="btn_accion" id="btn_eliminar" value="eliminar" class="btn btn-outline-danger btn-lg" onclick="javascript:if(!confirm('¿Desea Eliminar?')) return false">Eliminar</button>
